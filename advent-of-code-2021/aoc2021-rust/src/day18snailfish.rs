/// Credits to https://github.com/jocelyn-stericker/aoc/blob/main/p2021_18/src/lib.rs
...
impl Number {
    ...
    fn parse(input: &mut &[char]) -> Number {
        match input[0] {
            ...
            d => {
                let n = Number::Regular(d.to_digit(10).expect(&format!("'{}' was not a digit", d)));
                *input = &(*input)[1..];
                n
            }
        }
...
fn to_nums(input: &str) -> Vec<Number> {
...
mod tests {
    #[test]
    fn explode1() {
        assert_eq!(super::part_1("[[[[[9,8],1],2],3],4]"), 548);
    }

    #[test]
    fn explode2() {
        assert_eq!(super::part_1("[7,[6,[5,[4,[3,2]]]]]"), 285);
    }

    #[test]
    fn explode3() {
        assert_eq!(super::part_1("[[3,[2,[1,[7,3]]]],[6,[5,[4,[3,2]]]]]"), 633);
    }

    #[test]
    fn example0() {
        assert_eq!(super::part_1("[9,1]",), 29);
    }
    #[test]
    fn example1() {
        assert_eq!(
...
[[[[5,2],5],[8,[3,7]]],[[5,[7,5]],[4,4]]]"
    ...
    #[test]
    fn part_1() {
        assert_eq!(super::part_1(include_str!("../../input/day18.txt")), 3_486);
    }

    #[test]
    fn part_2() {
        assert_eq!(super::part_2(include_str!("../../input/day18.txt")), 4_747);
    }
}
